 ...
 * @author JianWenYang
 */
public class BuildDataModelPgCommandImpl implements IBuildDataModelSqlCommand {
    ...
    public String buildTimeDimensionCreateTable(String tableName) {
        ...
        str.append("DayNumberOfWeek int2  not null,");
        str.append("EnglishDayNameOfWeek varchar(10) not null,");
        str.append("DayNumberOfMonth int2 not null,");
        str.append("DayNumberOfYear int2 not null,");
        str.append("WeekNumberOfYear int2 not null,");
