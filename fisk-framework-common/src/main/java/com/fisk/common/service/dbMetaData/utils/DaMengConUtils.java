...
public class DaMengConUtils {
    ...
    public List<TablePyhNameDTO> getTableNames(String url, String user, String password, DataSourceTypeEnum driverTypeEnum) {
        ...
        try {
            ...
            log.error("【DaMengConUtils-getTableNames】获取表名报错：", e);
            log.error("数据库url信息：" + url);
            throw new FkException(ResultEnum.DATAACCESS_GETFIELD_ERROR);
        } finally {
            try {
                ...
                log.error("【DaMengConUtils-getTableNames】关闭数据库连接异常：", e);
                throw new FkException(ResultEnum.DATAACCESS_GETFIELD_ERROR);
            }
        }
        return list;
    ...
    public List<TableStructureDTO> getTableColumns(String url, String user, String password, DataSourceTypeEnum driverTypeEnum, String tableName) {
        ...
        try {
            ...
            log.error("【DaMengConUtils-getTableColumns】获取表名报错：", e);
            log.error("数据库url信息：" + url);
            throw new FkException(ResultEnum.DATAACCESS_GETFIELD_ERROR);
        } finally {
            try {
                ...
                log.error("【DaMengConUtils-getTableColumns】关闭数据库连接异常：", e);
                throw new FkException(ResultEnum.DATAACCESS_GETFIELD_ERROR);
            }
        }
        return list;
    ...
    public List<String> getTablesPlus(Connection conn) {
        ...
        try {
            ...
            ResultSet tables = databaseMetaData.getTables(null, conn.getSchema(), "%", new String[]{"TABLE"});
    ...
    private List<String> loadViewNameList(Connection conn) {
        ...
        try {
            ...
            ResultSet rs = databaseMetaData.getTables(null, conn.getSchema(), "%", types);
