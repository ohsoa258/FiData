package com.fisk.dataservice.handler.webservice;
...
public abstract class WebServiceHandler {
    ...
    public void setTableAppService(ITableAppManageService tableAppService) {
        WebServiceHandler.tableAppService = tableAppService;
    }
    @Autowired
    public void setTableApiService(ITableApiService tableApiService) {
        WebServiceHandler.tableApiService = tableApiService;
    }
    @Autowired
    public void setTableApiParameterService(ITableApiParameterService tableApiParameterService) {
        WebServiceHandler.tableApiParameterService = tableApiParameterService;
    }
    @Autowired
    public void setUserClient(UserClient userClient) {
        WebServiceHandler.userClient = userClient;
    }
