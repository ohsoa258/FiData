...
@MapperScan("com.fisk.taskfactory.mapper")
...
@EnableApolloConfig
public class FkTaskFactoryApplication {

    public static void main(String[] args) {
        SpringApplication.run(FkTaskFactoryApplication.class, args);
    }
