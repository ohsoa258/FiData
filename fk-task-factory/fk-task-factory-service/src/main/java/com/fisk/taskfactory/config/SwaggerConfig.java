package com.fisk.taskfactory.config;

import com.fisk.common.constants.SystemConstants;
import com.fisk.taskfactory.FkTaskFactoryApplication;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        String basePck = FkTaskFactoryApplication.class.getPackage().getName();
