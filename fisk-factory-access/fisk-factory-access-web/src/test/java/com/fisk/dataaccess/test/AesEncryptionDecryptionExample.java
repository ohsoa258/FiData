...
public class AesEncryptionDecryptionExample {
    ...
    // 生成 AES128 密钥
    private static SecretKey generateAes128Key() throws Exception {
        // 使用AES加密算法
    ...
    // 加密 JSON 数据
    private static String encryptJsonData(String jsonData, SecretKey secretKey) throws Exception {
    ...
    // 解密加密后的数据
    private static String decryptJsonData(String encryptedData, SecretKey secretKey) throws Exception {
