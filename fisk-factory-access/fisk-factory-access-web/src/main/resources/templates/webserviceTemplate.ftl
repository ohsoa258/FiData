...
<div>
    <div>
        <div>
            <p style="font-weight: bold;">二.&nbsp;&nbsp;WebService 接口</p>
        </div>
    </div>
    <div>
        <div>
    ...
    <#list apiBasicInfoDTOS as apiBasicItem>
        ...
        <!--webservice推送数据 json格式 start-->
        <div>
            <div>
                <p style="font-weight: bold;color: coral"> &nbsp;webservice推送数据--格式</p>
            </div>
            <div style="width: 100%;padding: 20px;">
        ...
        <div>
            <div>
                <p style="font-weight: bold;color: coral"> &nbsp;webservice推送数据--字段描述</p>
            </div>
            <div>
                <table style="border-collapse: collapse; margin: auto; border: 1px solid #c6c6c6;width: 100%">
                    <thead>
...
<div>
    ...
    <div>
        <table style="border-collapse: collapse; margin: auto; border: 1px solid #c6c6c6;width: 100%">
            ...
            <tbody>
            <#list pushDataDtos as pushDataItem>
                <tr style="${pushDataItem.trStyle!}">
                    <td style="border-collapse: collapse;
            border: 1px solid #c6c6c6;
            padding: 8px 9px;
