package com.fisk.license.config;

import com.fisk.common.core.constants.SystemConstants;
import com.fisk.license.FkLicenseRegistryApplication;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        String basePck = FkLicenseRegistryApplication.class.getPackage().getName();
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .tags(new Tag(LICENSE_CONTROLLER, "license"))
                .select()
