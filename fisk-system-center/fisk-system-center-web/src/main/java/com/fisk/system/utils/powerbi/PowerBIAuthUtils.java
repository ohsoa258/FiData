package com.fisk.system.utils.powerbi;
...
public class PowerBIAuthUtils {
    ...
    private String AUTHORITY_URL = "https://login.microsoftonline.com/";
    private String TOKEN_ENDPOINT = "/oauth2/v2.0/token";
    private String SCOPE = "https://analysis.windows.net/powerbi/api/.default";
