...
public class BuildDataModelDorisTableListener
    ...
    public List<String> createPgdbTable2(ModelPublishTableDTO modelPublishTableDTO) {
        ...
        sql2 +=",error_message text,fidata_batch_code varchar(50),fidata_flow_batch_code varchar(50), sync_type varchar(50) DEFAULT '2',verify_type varchar(50) DEFAULT '3'";
