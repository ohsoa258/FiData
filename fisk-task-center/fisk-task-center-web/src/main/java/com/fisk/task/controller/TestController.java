...
//            /
    ...
    @PostMapping("/kfk")
    public void kfk() {
        String dd = "{\"appId\":103,\"concurrencyNums\":1,\"dataClassifyEnum\":\"DATAACCESS\",\"dataSourceDbId\":2,\"deleteScript\":\"DELETE FROM [dbo].[stg_nt_nt001] WHERE fi_createtime<DATEADD(DAY,-5,getdate())\",\"deltaTimes\":[{\"deltaTimeParameterTypeEnum\":\"THE_DEFAULT_EMPTY\",\"systemVariableTypeEnum\":\"START_TIME\",\"variableValue\":\"\"},{\"deltaTimeParameterTypeEnum\":\"THE_DEFAULT_EMPTY\",\"systemVariableTypeEnum\":\"END_TIME\",\"variableValue\":\"\"}],\"excelFlow\":false,\"fetchSize\":10000,\"generateVersionSql\":\"\",\"id\":5448,\"ifApi\":false,\"logId\":2671,\"maxRowsPerFlowFile\":10000,\"openTransmission\":true,\"pkName\":\"nt_nt001key\",\"popout\":true,\"sapBwFlow\":false,\"sftpFlow\":false,\"sourceFieldNames\":[],\"synMode\":0,\"syncStgToOdsSql\":\"DELETE FROM\\n  [dbo].[ods_nt_nt001]\\nWHERE\\n  fidata_batch_code <> '${fidata_batch_code}';\\nINSERT INTO\\n  [dbo].[ods_nt_nt001] (\\n    [MDCD_TYPE],\\n    [MDCD_CODE],\\n    [MDCD_DESCRIPTION],\\n    [MDCD_JOB],\\n    [MDCD_ENTITY],\\n    [MDCD_CREATION_DATE],\\n    [MDCD_LAST_UPDATE],\\n    fi_createtime,\\n    fi_updatetime,\\n    fidata_batch_code\\n  )\\nSELECT\\n  CAST([MDCD_TYPE] AS FLOAT) AS [MDCD_TYPE],\\n  CAST([MDCD_CODE] AS NVARCHAR(255)) AS [MDCD_CODE],\\n  CAST([MDCD_DESCRIPTION] AS NVARCHAR(2000)) AS [MDCD_DESCRIPTION],\\n  CAST([MDCD_JOB] AS NVARCHAR(255)) AS [MDCD_JOB],\\n  CAST([MDCD_ENTITY] AS NVARCHAR(255)) AS [MDCD_ENTITY],\\n  CASE\\n    WHEN CAST(isnumeric([MDCD_CREATION_DATE]) AS int) <= 0 THEN [MDCD_CREATION_DATE]\\n    ELSE convert(\\n      datetime,\\n      DATEADD(\\n        MINUTE,\\n        CAST(left([MDCD_CREATION_DATE], 10) AS bigint) / 60,\\n        '1970-01-01 08:00:00'\\n      ),\\n      112\\n    )\\n  END,\\n  CASE\\n    WHEN CAST(isnumeric([MDCD_LAST_UPDATE]) AS int) <= 0 THEN [MDCD_LAST_UPDATE]\\n    ELSE convert(\\n      datetime,\\n      DATEADD(\\n        MINUTE,\\n        CAST(left([MDCD_LAST_UPDATE], 10) AS bigint) / 60,\\n        '1970-01-01 08:00:00'\\n      ),\\n      112\\n    )\\n  END,\\n  getdate(),\\n  getdate(),\\n  fidata_batch_code\\nFROM\\n  [dbo].[stg_nt_nt001] SOURCE WITH(nolock)\\nWHERE\\n  fidata_batch_code = '${fidata_batch_code}'\\n  AND fidata_flow_batch_code = '${fragment.index}'\\n  AND fi_verify_type <> '2'\",\"synchronousTypeEnum\":\"TOPGODS\",\"tableHistoryId\":354,\"tableName\":\"nt_nt001\",\"targetDbId\":2,\"traceId\":\"707fdae6-27b9-49e4-ba6f-3a045095c4f5\",\"type\":\"PHYSICS\",\"userId\":3,\"whereScript\":\"\"}";
...
//    }
    ...
    @PostMapping("/lsjaa")
    public void MyLsjTest() {
        buildDataModelDorisTableListener.msg("{\n" +
                "    \"businessAreaId\":5,\n" +
                "    \"businessAreaName\":\"doris_test\",\n" +
                "    \"dimOrFact\":\"FACT\",\n" +
                "    \"dimensionList\":[\n" +
                "        {\n" +
                "            \"coverScript\":\"DELETE FROM\\n `fact_dr26key`\\nWHERE\\n fidata_batch_code &lt;&gt; '${fidata_batch_code}';\\nINSERT INTO\\n `fact_dr26key` (\\n `PK_CODIFICATION`,\\n `TIMESTAMP`,\\n `MDCD_TYPE`,\\n `MDCD_CODE`,\\n `MDCD_DESCRIPTION`,\\n `MDCD_JOB`,\\n `MDCD_ENTITY`,\\n `MDCD_CREATION_DATE`,\\n `MDCD_LAST_UPDATE`,\\n fi_createtime,\\n fi_updatetime,\\n fidata_batch_code,\\n `dr26keykey`\\n )\\nSELECT\\n CAST(`PK_CODIFICATION` AS VARCHAR(2000)) AS `PK_CODIFICATION`,\\n CAST(`TIMESTAMP` AS VARCHAR(2000)) AS `TIMESTAMP`,\\n CAST(`MDCD_TYPE` AS VARCHAR(2000)) AS `MDCD_TYPE`,\\n CAST(`MDCD_CODE` AS VARCHAR(2000)) AS `MDCD_CODE`,\\n CAST(`MDCD_DESCRIPTION` AS VARCHAR(2000)) AS `MDCD_DESCRIPTION`,\\n CAST(`MDCD_JOB` AS VARCHAR(2000)) AS `MDCD_JOB`,\\n CAST(`MDCD_ENTITY` AS VARCHAR(2000)) AS `MDCD_ENTITY`,\\n CAST(`MDCD_CREATION_DATE` AS VARCHAR(2000)) AS `MDCD_CREATION_DATE`,\\n CAST(`MDCD_LAST_UPDATE` AS VARCHAR(2000)) AS `MDCD_LAST_UPDATE`,\\n now(),\\n now(),\\n fidata_batch_code,\\n row_number() over() as `dr26keykey`\\nFROM\\n `temp_fact_dr26key`\\nWHERE\\n fidata_batch_code = '${fidata_batch_code}'\\n AND fidata_flow_batch_code = '${fragment.index}'\\n AND fi_verify_type &lt;&gt; '2'\",\n" +
                "            \"createType\":1,\n" +
                "            \"dataSourceDbId\":2,\n" +
                "            \"deleteTempScript\":\"TRUNCATE TABLE temp_fact_dr26key;\",\n" +
                "            \"factUpdateSql\":\"\",\n" +
                "            \"fetchSize\":10000,\n" +
                "            \"fieldList\":[\n" +
                "                {\n" +
                "                    \"associateDimensionFieldId\":0,\n" +
                "                    \"associateDimensionId\":0,\n" +
                "                    \"attributeType\":0,\n" +
                "                    \"fieldEnName\":\"PK_CODIFICATION\",\n" +
                "                    \"fieldId\":359,\n" +
                "                    \"fieldLength\":2000,\n" +
                "                    \"fieldType\":\"VARCHAR\",\n" +
                "                    \"isAggregateKey\":0,\n" +
                ...
                "                    \"isPartitionKey\":0,\n" +
                "                    \"isPrimaryKey\":0,\n" +
                "                    \"sourceFieldName\":\"PK_CODIFICATION\"\n" +
                "                },\n" +
                "                {\n" +
                "                    \"associateDimensionFieldId\":0,\n" +
                "                    \"associateDimensionId\":0,\n" +
                "                    \"attributeType\":0,\n" +
                "                    \"fieldEnName\":\"TIMESTAMP\",\n" +
                "                    \"fieldId\":360,\n" +
                "                    \"fieldLength\":2000,\n" +
                "                    \"fieldType\":\"VARCHAR\",\n" +
                "                    \"isAggregateKey\":0,\n" +
                ...
                "                    \"isPartitionKey\":0,\n" +
                "                    \"isPrimaryKey\":0,\n" +
                "                    \"sourceFieldName\":\"MDCD_TYPE\"\n" +
                "                },\n" +
                "                {\n" +
                "                    \"associateDimensionFieldId\":0,\n" +
                "                    \"associateDimensionId\":0,\n" +
                "                    \"attributeType\":0,\n" +
                "                    \"fieldEnName\":\"MDCD_CODE\",\n" +
                "                    \"fieldId\":362,\n" +
                "                    \"fieldLength\":2000,\n" +
                "                    \"fieldType\":\"VARCHAR\",\n" +
                "                    \"isAggregateKey\":0,\n" +
                ...
                "                    \"isPartitionKey\":0,\n" +
                "                    \"isPrimaryKey\":0,\n" +
                "                    \"sourceFieldName\":\"MDCD_CODE\"\n" +
                "                },\n" +
                "                {\n" +
                "                    \"associateDimensionFieldId\":0,\n" +
                "                    \"associateDimensionId\":0,\n" +
                "                    \"attributeType\":0,\n" +
                "                    \"fieldEnName\":\"MDCD_DESCRIPTION\",\n" +
                "                    \"fieldId\":363,\n" +
                "                    \"fieldLength\":2000,\n" +
                "                    \"fieldType\":\"VARCHAR\",\n" +
                "                    \"isAggregateKey\":0,\n" +
                ...
                "                    \"isPartitionKey\":0,\n" +
                "                    \"isPrimaryKey\":0,\n" +
                "                    \"sourceFieldName\":\"MDCD_DESCRIPTION\"\n" +
                "                },\n" +
                "                {\n" +
                "                    \"associateDimensionFieldId\":0,\n" +
                "                    \"associateDimensionId\":0,\n" +
                "                    \"attributeType\":0,\n" +
                "                    \"fieldEnName\":\"MDCD_JOB\",\n" +
                "                    \"fieldId\":364,\n" +
                "                    \"fieldLength\":2000,\n" +
                "                    \"fieldType\":\"VARCHAR\",\n" +
                "                    \"isAggregateKey\":0,\n" +
                ...
                "                    \"isPartitionKey\":0,\n" +
                "                    \"isPrimaryKey\":0,\n" +
                "                    \"sourceFieldName\":\"MDCD_JOB\"\n" +
                "                },\n" +
                "                {\n" +
                "                    \"associateDimensionFieldId\":0,\n" +
                "                    \"associateDimensionId\":0,\n" +
                "                    \"attributeType\":0,\n" +
                "                    \"fieldEnName\":\"MDCD_ENTITY\",\n" +
                "                    \"fieldId\":365,\n" +
                "                    \"fieldLength\":2000,\n" +
                "                    \"fieldType\":\"VARCHAR\",\n" +
                "                    \"isAggregateKey\":0,\n" +
                ...
                "                    \"isPartitionKey\":0,\n" +
                "                    \"isPrimaryKey\":0,\n" +
                "                    \"sourceFieldName\":\"MDCD_ENTITY\"\n" +
                "                },\n" +
                "                {\n" +
                "                    \"associateDimensionFieldId\":0,\n" +
                "                    \"associateDimensionId\":0,\n" +
                "                    \"attributeType\":0,\n" +
                "                    \"fieldEnName\":\"MDCD_CREATION_DATE\",\n" +
                "                    \"fieldId\":366,\n" +
                "                    \"fieldLength\":2000,\n" +
                "                    \"fieldType\":\"VARCHAR\",\n" +
                "                    \"isAggregateKey\":0,\n" +
                ...
                "                    \"isPartitionKey\":0,\n" +
                "                    \"isPrimaryKey\":0,\n" +
                "                    \"sourceFieldName\":\"MDCD_CREATION_DATE\"\n" +
                "                },\n" +
                "                {\n" +
                "                    \"associateDimensionFieldId\":0,\n" +
                "                    \"associateDimensionId\":0,\n" +
                "                    \"attributeType\":0,\n" +
                "                    \"fieldEnName\":\"MDCD_LAST_UPDATE\",\n" +
                "                    \"fieldId\":367,\n" +
                "                    \"fieldLength\":2000,\n" +
                "                    \"fieldType\":\"VARCHAR\",\n" +
                "                    \"isAggregateKey\":0,\n" +
                ...
                "                    \"isPartitionKey\":0,\n" +
                "                    \"isPrimaryKey\":0,\n" +
                "                    \"sourceFieldName\":\"MDCD_LAST_UPDATE\"\n" +
                "                },{\n" +
                "                    \"associateDimensionFieldId\":0,\n" +
                "                    \"associateDimensionId\":0,\n" +
                "                    \"attributeType\":0,\n" +
                "                    \"fieldEnName\":\"MDCD_LAST_UPDATEkey\",\n" +
                "                    \"fieldId\":368,\n" +
                "                    \"fieldLength\":2000,\n" +
                "                    \"fieldType\":\"VARCHAR\",\n" +
                "                    \"isAggregateKey\":0,\n" +
                ...
                "                    \"isPartitionKey\":0,\n" +
                "                    \"isPrimaryKey\":0,\n" +
                "                    \"sourceFieldName\":\"MDCD_LAST_UPDATEkey\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"maxRowsPerFlowFile\":10000,\n" +
                "            \"prefixTempName\":\"temp_\",\n" +
                "            \"sqlScript\":\"SELECT\\n PK_CODIFICATION,\\n TIMESTAMP,\\n MDCD_TYPE,\\n MDCD_CODE,\\n MDCD_DESCRIPTION,\\n MDCD_JOB,\\n MDCD_ENTITY,\\n MDCD_CREATION_DATE,\\n MDCD_LAST_UPDATE\\nFROM\\n sd_objects.coswin_codification\",\n" +
                "            \"synMode\":1,\n" +
                "            \"tableId\":57,\n" +
                "            \"tableName\":\"fact_dr26key111\",\n" +
                "            \"targetDbId\":13\n" +
                "        }\n" +
                "    ],\n" +
                "    \"logId\":1341,\n" +
                ...
                "    \"popout\":false,\n" +
                "    \"spanId\":\"b166ee20-8868-4ea0-87bf-be3810c9c253\",\n" +
                "    \"traceId\":\"0eec4236-7fc3-4743-90de-61a6e8fccbcf\",\n" +
                "    \"userId\":3\n" +
                "}", null);
    }
