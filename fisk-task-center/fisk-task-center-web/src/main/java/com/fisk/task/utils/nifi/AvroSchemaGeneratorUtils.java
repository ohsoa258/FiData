...
public class AvroSchemaGeneratorUtils {
...
//    }
     ...
     * @throws IOException
     */
    public static String getAvroSchema(String jsonString, String schema) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        JsonNode rootNode = objectMapper.readTree(jsonString);
        Schema ordersSchema = generateSchema(rootNode, schema);
        return ordersSchema.toString(true);
    }

    private static Schema generateSchema(JsonNode rootNode, String schema) {
        SchemaBuilder.FieldAssembler<Schema> fieldAssembler = SchemaBuilder.record(schema).fields();
