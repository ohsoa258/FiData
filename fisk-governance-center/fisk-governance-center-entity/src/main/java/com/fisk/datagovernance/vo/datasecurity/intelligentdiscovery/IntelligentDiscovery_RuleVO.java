...
@Data
public class IntelligentDiscovery_RuleVO {
    /**
     * 主键ID
     */
    ...
    public IntelligentDiscovery_NoticeVO notice;

    /**
     * 智能发现-关键字规则列表
     */
    @ApiModelProperty(value = "智能发现-关键字规则列表")
    public List<IntelligentDiscovery_KeyWordRuleVO> keyWordRules;

    /**
     * 智能发现-扫描配置列表
     */
    @ApiModelProperty(value = "智能发现-扫描配置列表")
    public List<IntelligentDiscovery_ScanVO> scans;

    /**
     * 智能发现-扫描结果接收人列表
     */
    @ApiModelProperty(value = "智能发现-扫描结果接收人列表")
    public List<IntelligentDiscovery_UserVO> users;
}
