package com.fisk.taskschedule.config;

import com.fisk.common.constants.SystemConstants;
import com.fisk.taskschedule.FkTaskScheduleApplication;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        String basePck = FkTaskScheduleApplication.class.getPackage().getName();
