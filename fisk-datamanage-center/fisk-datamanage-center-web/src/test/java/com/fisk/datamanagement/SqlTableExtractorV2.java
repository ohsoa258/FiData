...
public class SqlTableExtractorV2 {

    public static void main(String[] args) {
        String sql = "SELECT TOP 10000 NEWID() AS uGUID,B.uGUID AS upsWorkFlowCardGUID,B.upsWorkFlowCardGUID AS upsWorkFlowCardGUIDSource,\n" +
                ...
                "WHERE A.dReleaseDate>='2020-06-01' and  A.sCustomerOrderNo like N'%LCH%'\n" +
