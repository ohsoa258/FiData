...
public class OracleUtils {
     ...
     * @return
     */
    public List<com.fisk.common.service.dbMetaData.dto.TablePyhNameDTO> getTrueTableNameList(Connection conn, String schemaName, String dbName) {
        Statement st = null;
        List<com.fisk.common.service.dbMetaData.dto.TablePyhNameDTO> list = new ArrayList<>();
        try {
            // 获取数据库中所有表名称
            List<String> tableList = getTables(conn);
            if (CollectionUtils.isEmpty(tableList)) {
            ...
            list = new ArrayList<>();
            for (String tableName : tableList) {
                com.fisk.common.service.dbMetaData.dto.TablePyhNameDTO tablePyhNameDTO = new com.fisk.common.service.dbMetaData.dto.TablePyhNameDTO();
                ...
                List<com.fisk.common.service.dbMetaData.dto.TableStructureDTO> colNameList = new ArrayList<>();
                while (rs.next()) {
                    colNameList.add(conversionTypeV2(rs, tableName, dbName));
                }
                tablePyhNameDTO.setTableFullName(schemaName + "." + tableName);
                tablePyhNameDTO.setTableName(tableName);
                tag++;
     ...
     * @return
     */
    public com.fisk.common.service.dbMetaData.dto.TableStructureDTO conversionTypeV2(ResultSet rs, String tableName, String dbName) {
        try {
            com.fisk.common.service.dbMetaData.dto.TableStructureDTO dto = new com.fisk.common.service.dbMetaData.dto.TableStructureDTO();
            //dto.fieldDes = rs.getString("COMMENTS");
            dto.fieldName = rs.getString("COLUMN_NAME");
            dto.fieldType = rs.getString("DATA_TYPE");
            dto.fieldLength = Integer.parseInt(rs.getString("DATA_LENGTH"));
