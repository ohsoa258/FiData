...
import com.fisk.mdm.factory.BuildMdmOverlayCodeProcessorFactory;
...
//    }
    ...
    public Object mdmOverlayCodePreview(OverlayCodePreviewAccessDTO dto) {
        ...
        String finalSql = "";
        BuildMdmOverlayCodeProcessor dbProcessor = BuildMdmOverlayCodeProcessorFactory.getDBProcessor(fiDataDataSource.data.conType);
        switch (dto.getSyncMode()){
            case 1:
                finalSql = dbProcessor.buildMeargeByAllData(attributeList, stgTableName, mdmTableName, dto.versionId);
                break;
            case 2:
                break;
            case 3:
                finalSql = dbProcessor.buildMeargeByPrimaryKey(attributeList, stgTableName, mdmTableName, dto.versionId);
                break;
            default:
                break;
        }
